...
class Main extends React.Component {
	...
	componentWillMount() {
		...
		this.setState({ roleSet: localStorage.getItem("user_type") })
				...
				<div id="leftMenu">
					...
					<div>
						...
						>
							...
							{
								this.state.roleSet == '2' ? <SubMenu key="student_manage" title={<span><Icon type="usergroup-add" /><span>学生管理</span></span>}>
							...
							{
								this.state.roleSet == '2' ? <SubMenu key="teacher_manage" title={<span><Icon type="user-add" /><span>教师管理</span></span>}>
							...
							{
								this.state.roleSet == '2' ? <SubMenu key="class_manage" title={<span><Icon type="layout" /><span>班级管理</span></span>}>
							...
							<SubMenu key="paper_manage" title={<span><Icon type="desktop" /><span>考试管理</span></span>}>
								{
									this.state.roleSet == '2' ?<Menu.Item key="create_exam"><Link to="/main/paper_manage/create_exam">创建考试</Link></Menu.Item>:''
								}
				...
				<div id="rightWrap">
					...
					<div className="right-box">
						<Switch>
							...
							<Route path="/main/paper_manage/scoring/all_papers/reading_paper/:paperId/:classId/:stuId" component={ReadingPaper} />
							<Route path="/main/paper_manage/scoring/all_papers/:paperId/:classId" component={AllPapers} />
